<html>
    ...
    <body>
        ...
        <p>
            По заказу №<?= $order->order_id ?> поступило возражение от клиента. Ожидайте звонка от администратора. Больше действий с заказом <a href="https://tezkel.com/#/order-<?= $order->order_id ?>">в приложении</a>
        </p>
