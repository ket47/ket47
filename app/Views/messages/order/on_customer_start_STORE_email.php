<html>
    ...
    <body>
        ...
        <p>
            Мы получили заказ для вас. Поиск курьера уже запущен, но пока не найден. Когда мы найдем курьера вы будете уведомлены. Больше действий с заказом <a href="https://tezkel.com/order/order-<?= $order->order_id ?>">в приложении</a>
        </p>
