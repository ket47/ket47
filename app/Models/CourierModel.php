...
class CourierModel extends Model{
    ...
    public function itemJobTrack($order_id){
        ...
        $OrderModel->select("courier_name,image_hash,location_id courier_location_id,location_latitude,location_longitude,TIMESTAMPDIFF(SECOND,location_list.created_at,NOW()) location_age");
